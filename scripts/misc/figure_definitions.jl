...
ins_label = L"$I$ ($\mathrm{W~m^{-2}}$)"
periods_label = L"$P$ (kyr)"
d18O_label = L"δ$^{18}$O (‰) $\,$"
temp_label = L"$T$ ($\mathrm{^oC}$)"
carbon_label = L"$C$ (ppm)"
icethick_label = L"$H$ (m)"
z_label = L"$z$ (m)"
icevol_label = L"$V_\mathrm{ice}$ ($\mathrm{m~SLE}$)"
sed_label = L"$H_\mathrm{sed}$ (m)"
elev_label = L"Elevation (m)$\,$"
mb_label = L"$\dot{m}$ ($\mathrm{m~yr^{-1}}$)"
snowfall_label = L"$\dot{s}$ ($\mathrm{m~yr^{-1}}$)"
ablation_label = L"$-\dot{a}$ ($\mathrm{m~yr^{-1}}$)"
v_label = L"$v$ ($\mathrm{m~yr^{-1}}$)"

insdot_label = L"$dI/dt$ ($\mathrm{W~m^{-2}~yr^{-1}}$)"
icethickdot_label = L"$dH/dt$ ($\mathrm{m~yr^{-1}}$)"
tempdot_label = L"$dT/dt$ ($\mathrm{K~yr^{-1}}$)"
icevoldot_label = L"$dV_\mathrm{ice}/dt$ ($\mathrm{m~SLE~yr^{-1}}$)"
mbdot_label = L"$d \dot{m}/dt$ ($\mathrm{m~yr^{-2}}$)"
vdot_label = L"$v$ ($\mathrm{m~yr^{-2}}$)"

# Ticks and positions
ticks_periods = [20, 40, 100]

xticks_time_short = Int.(-1.5e3:250:250)    # kyr
xticks_time_long = Int.(-3e3:300:300)       # kyr
xticks_time_800 = Int.(-800:100:0)       # kyr
xticks_time_2000 = Int.(-2.0e3:250:250)    # kyr
