...
axislegend(ax, framevisible=false, position=(:center, :center), labelsize=fontsize, nbanks=4)
...
text!(ax, -2980, 2.5, text=f_label, align=(:left, :center))
...
hidespines!(ax, :t)
hlines!(ax, [0.0], color=background_color, linestyle=:solid)
text!(ax, -2980, 40, text=g_label, align=(:left, :center))
...
save("figures/rc1_fig02_BASE.png", fig)
save("figures/rc1_fig02_BASE.pdf", fig)